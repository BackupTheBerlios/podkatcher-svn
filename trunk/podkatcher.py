...
#############################################################################
# podKatcher - PyQT application template for KDevelop
#
...
class podKatcher(QMainWindow):
    """An application called podKatcher."""

    def __init__(self):
        QMainWindow.__init__(self, None, "podKatcher")
        self.initIcons()
        self.setup()
        self.initPrinter()
        self.initToolBar()
    ...
    def setup(self):
        ...
        self.appTitle = "podKatcher - PyQT Application Example"
